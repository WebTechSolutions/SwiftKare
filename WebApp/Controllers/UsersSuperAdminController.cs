...
namespace WebApp.Controllers
{
    ...
    public class UsersSuperAdminController : Controller
    {
        public UsersSuperAdminController()
        {
          
        }

        public UsersSuperAdminController(ApplicationUserManager userManager, ApplicationRoleManager roleManager)
        {
